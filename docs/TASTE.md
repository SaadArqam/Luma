...
- **Design System**: `.claude/DESIGN-luma.md` - Detailed design tokens and component specifications
- **Brand Guidelines**: `docs/BRAND.md` - Brand identity and visual identity
- **Product Philosophy**: `docs/PHILOSOPHY.md` - Core beliefs and design philosophy
- **UX Principles**: `docs/UX_PRINCIPLES.md` - User experience principles

---

**Note:** This taste document is a living document. It will be updated as the design system evolves and new patterns are established.
